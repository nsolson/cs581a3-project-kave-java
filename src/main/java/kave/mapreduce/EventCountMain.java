...
public class EventCountMain {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		jobOne.setJarByClass(EventCountMain.class);
		jobOne.setMapperClass(EventCountMapper.class);
		jobOne.setReducerClass(EventCountReducer.class);
