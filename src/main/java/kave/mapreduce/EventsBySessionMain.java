...
public class EventsBySessionMain {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		jobOne.setJarByClass(EventsBySessionMain.class);
		jobOne.setMapperClass(EventsBySessionMapper.class);
		jobOne.setReducerClass(EventsBySessionReducer.class);
		...
		jobOne.setOutputValueClass(EventsWritable.class);
